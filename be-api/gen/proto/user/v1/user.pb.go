...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\x10GetLibraryCookie\x12 .user.v1.GetLibraryCookieRequest\x1a!.user.v1.GetLibraryCookieResponseB@Z>github.com/asynccnu/ccnubox-be/be-api/gen/proto/user/v1;userv1b\x06proto3"
