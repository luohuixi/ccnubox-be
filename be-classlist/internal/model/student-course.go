...
type StudentCourse struct {
	...
	ClaID           string    `gorm:"type:varchar(255);column:cla_id;not null;uniqueIndex:idx_sc,priority:5" json:"cla_id"`          //课程ID
	...
	IsManuallyAdded bool      `gorm:"column:is_manually_added;default:false;uniqueIndex:idx_sc,priority:4" json:"is_manually_added"` //是否为手动添加
